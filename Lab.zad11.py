...
for i in range(9):
    ...
    if i < 3:
        przycisk_c = Button(okno, width=3, text=str(i+1), command=(lambda c=i+1:cyfry(c)))
...
przycisk_0 = Button(okno,width=3, text='0', command=(lambda c=0:cyfry(c)))
przycisk_0.grid(row=4,column=0)

przycisk_c = Button(okno,width=3, text='C', command=czysc)
przycisk_c.grid(row=4,column=1)

przycisk_r = Button(okno,width=3, text='=', command=wynik)
przycisk_r.grid(row=4,column=2)
